...
!     first check for fragments
      ...
      if(pr) write(env%unit,'(10x,"#fragments for EEQ constrain: ",i0)') topo%nfrag
...
!        printout
      ...
      if(pr) write(env%unit,'(10x,"#tors  :",3x,i0)') topo%ntors
      if(pr) write(env%unit,'(10x,"#nmol  :",3x,i0)') topo%nfrag
